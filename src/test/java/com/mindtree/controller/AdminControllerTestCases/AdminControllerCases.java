...
public void getComplaints() throws Exception {
    ...
    mockMvc.perform(get("/GreenCard/admin/newgreencards"))
...
public void getCount() throws Exception {
	when(adminServiceImpl.newcount()).thenReturn(1);
	 mockMvc.perform(get("/GreenCard/admin/newcount"))
	   .andExpect(status().isOk());
...
public void assigncardTest() throws Exception {
	...
	mockMvc.perform(post("/GreenCard/admin/assigncard").contentType(MediaType.APPLICATION_JSON).content(asJsonString(inProgressGreenCard)))
    .andExpect(status().isOk());
...
public void resolveCardTest() throws Exception {
	...
	mockMvc.perform(get("/GreenCard/admin//resolve/{gid}/{rootcause}/{correctiveaction}",1,"rootcause","correctiveaction")).andExpect(status().isOk());
